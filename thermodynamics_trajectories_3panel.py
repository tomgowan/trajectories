...
ds = xr.open_dataset('/uufs/chpc.utah.edu/common/home/steenburgh-group8/tom/cm1/output/tug/cm1run_150m_25ms_0500m_90sec.nc')#ni': 1000, 'nj':200, 'nk':20})
...
start_time_step = 310 ###465 for 60 second run### #Starting time step
...
#    
##Save arrays
#np.save('xpos_traj_disp_25ms_0500m_%dtime_steps' %time_steps, xpos)
#np.save('ypos_traj_disp_25ms_0500m_%dtime_steps' %time_steps, ypos)
#np.save('zpos_traj_disp_25ms_0500m_%dtime_steps' %time_steps, zpos_terrain)
#np.save('%s_traj_disp_25ms_0500m' %var_name1 + '_%dtime_steps' %time_steps, variable1)
#np.save('%s_traj_disp_25ms_0500m' %var_name2 + '_%dtime_steps' %time_steps, variable2)
...
#np.save('%s_traj_disp_25ms_0500m' %var_name6 + '_%dtime_steps' %time_steps, variable6)
##np.save('%s_traj_disp_15ms_0500m' %var_name7 + '_%dtime_steps' %time_steps, variable7)
#np.save('%s_traj_disp_25ms_0500m' %var_name8 + '_%dtime_steps' %time_steps, variable8)
...
#np.save('%s_traj_disp_25ms_0500m' %var_name11 + '_%dtime_steps' %time_steps, variable11)
...
#np.save('%s_traj_disp_25ms_0500m' %var_name15 + '_%dtime_steps' %time_steps, variable15)
...
#%%
xpos = np.load('xpos_traj_disp_15ms_0000m_300time_steps.npy')
ypos = np.load('ypos_traj_disp_15ms_0000m_300time_steps.npy')
zpos_terrain = np.load('zpos_traj_disp_15ms_0000m_300time_steps.npy')
variable1 = np.load('%s_traj_disp_15ms_0000m_300time_steps.npy' % var_name1)
variable2 = np.load('%s_traj_disp_15ms_0000m_300time_steps.npy' %var_name2)
variable6 = np.load('%s_traj_disp_15ms_0000m_300time_steps.npy' %var_name6)
variable8 = np.load('%s_traj_disp_15ms_0000m_300time_steps.npy' %var_name8)
variable11 = np.load('%s_traj_disp_15ms_0000m_300time_steps.npy' %var_name11)
variable15 = np.load('%s_traj_disp_15ms_0000m_300time_steps.npy' %var_name15)
...
variable6_small = np.load('%s_traj_disp_15ms_0500m_250time_steps.npy' %var_name6)
variable8_small = np.load('%s_traj_disp_15ms_0500m_250time_steps.npy' %var_name8)
variable11_small = np.load('%s_traj_disp_15ms_0500m_250time_steps.npy' %var_name11)
variable15_small = np.load('%s_traj_disp_15ms_0500m_250time_steps.npy' %var_name15)
...
variable6_tall = np.load('%s_traj_disp_15ms_2000m_250time_steps.npy' %var_name6)
variable8_tall = np.load('%s_traj_disp_15ms_2000m_250time_steps.npy' %var_name8)
variable11_tall = np.load('%s_traj_disp_15ms_2000m_250time_steps.npy' %var_name11)
variable15_tall = np.load('%s_traj_disp_15ms_2000m_250time_steps.npy' %var_name15)
...
var6_disp_small = np.zeros((time_steps-2, num_seeds_z, num_seeds_x))
var8_disp_small = np.zeros((time_steps-2, num_seeds_z, num_seeds_x))
var11_disp_small = np.zeros((time_steps-2, num_seeds_z, num_seeds_x))
var15_disp_small = np.zeros((time_steps-2, num_seeds_z, num_seeds_x))
...
var6_disp_tall = np.zeros((time_steps-2, num_seeds_z, num_seeds_x))
var8_disp_tall = np.zeros((time_steps-2, num_seeds_z, num_seeds_x))
var11_disp_tall = np.zeros((time_steps-2, num_seeds_z, num_seeds_x))
var15_disp_tall = np.zeros((time_steps-2, num_seeds_z, num_seeds_x))
...
###################   SMALL  ##################################################    
    ...
    var6_disp_small[t,:,:] =  np.sum(variable6_small[:t+1,:,:], axis = 0)
    var8_disp_small[t,:,:] =  np.sum(variable8_small[:t+1,:,:], axis = 0)
    
    #Tendancy variables
    var11_disp_small[t,:,:] =  np.sum(variable11_small[:t+1,:,:], axis = 0)
    var15_disp_small[t,:,:] =  np.sum(variable15_small[:t+1,:,:], axis = 0)
...
#####################   TALL   ################################################    
    ...
    var6_disp_tall[t,:,:] =  np.sum(variable6_tall[:t+1,:,:], axis = 0)
    var8_disp_tall[t,:,:] =  np.sum(variable8_tall[:t+1,:,:], axis = 0)
    
    #Tendancy variables
    var11_disp_tall[t,:,:] =  np.sum(variable11_tall[:t+1,:,:], axis = 0)
    var15_disp_tall[t,:,:] =  np.sum(variable15_tall[:t+1,:,:], axis = 0)
...
mean_z_disp = np.mean(z_disp[:ts_plot_60,:,:], axis = 0)
mean_x_disp = np.zeros((num_seeds_z, num_seeds_x))
mean_x_disp = np.mean(x_disp[:ts_plot_60,:,:], axis = 0)
mean_y_disp = np.zeros((num_seeds_z, num_seeds_x))
mean_y_disp = np.mean(y_disp[:ts_plot_60,:,:], axis = 0)

#Variable
mean_var1_disp = np.zeros((num_seeds_z, num_seeds_x))
mean_var1_disp = np.mean(var1_disp[:ts_plot_60,:,:], axis = 0)

##Budget Variables
mean_var2_disp = np.zeros((num_seeds_z, num_seeds_x))
mean_var2_disp = np.mean(var2_disp[:ts_plot_60,:,:], axis = 0)
mean_var6_disp = np.zeros((num_seeds_z, num_seeds_x))
mean_var6_disp = np.mean(var6_disp[:ts_plot_60,:,:], axis = 0)
mean_var8_disp = np.zeros((num_seeds_z, num_seeds_x))
mean_var8_disp = np.mean(var8_disp[:ts_plot_60,:,:], axis = 0)

#Tendencay Variable
mean_var11_disp = np.zeros((num_seeds_z, num_seeds_x))
mean_var11_disp = np.mean(var11_disp[:ts_plot_60,:,:], axis = 0)
mean_var15_disp = np.zeros((num_seeds_z, num_seeds_x))
mean_var15_disp = np.mean(var15_disp[:ts_plot_60,:,:], axis = 0)
...
mean_var6_disp_small = np.zeros((num_seeds_z, num_seeds_x))
mean_var6_disp_small = np.mean(var6_disp_small[:ts_plot,:,:], axis = 0)
mean_var8_disp_small = np.zeros((num_seeds_z, num_seeds_x))
mean_var8_disp_small = np.mean(var8_disp_small[:ts_plot,:,:], axis = 0)

#Tendencay Variable
mean_var11_disp_small = np.zeros((num_seeds_z, num_seeds_x))
mean_var11_disp_small = np.mean(var11_disp_small[:ts_plot,:,:], axis = 0)
mean_var15_disp_small = np.zeros((num_seeds_z, num_seeds_x))
mean_var15_disp_small = np.mean(var15_disp_small[:ts_plot,:,:], axis = 0)
...
mean_var6_disp_tall = np.zeros((num_seeds_z, num_seeds_x))
mean_var6_disp_tall = np.mean(var6_disp_tall[:ts_plot,:,:], axis = 0)
mean_var8_disp_tall = np.zeros((num_seeds_z, num_seeds_x))
mean_var8_disp_tall = np.mean(var8_disp_tall[:ts_plot,:,:], axis = 0)

#Tendencay Variable
mean_var11_disp_tall = np.zeros((num_seeds_z, num_seeds_x))
mean_var11_disp_tall = np.mean(var11_disp_tall[:ts_plot,:,:], axis = 0)
mean_var15_disp_tall = np.zeros((num_seeds_z, num_seeds_x))
mean_var15_disp_tall = np.mean(var15_disp_tall[:ts_plot,:,:], axis = 0)
...
fig = plt.figure(num=None, figsize=(20,12),  facecolor='w', edgecolor='k')
for j in range(1,4):
    subplot = 310 + j
    ...
    tlmin = -4
    tlmax = 6.01
    tlevels = np.arange(tlmin,tlmax, 0.1)
    tlevels_ticks = np.arange(tlmin,tlmax,2)
    tlevels_ticks_labels = np.arange(tlmin,tlmax, 2).astype(int)
#    
#    #Levels variable 2
#    xlmin = -4
#    xlmax = 6.01
...
###############################################################################
    ...
    shifted_cmapt = shiftedColorMap(cmap_dth, midpoint=1 - tlmax/(tlmax + abs(tlmin)), name='shifted')

    
    z = zpos_terrain[0,:,xleft:xright]/100*z_scaling
    z_small = zpos_terrain_small[0,:,xleft:xright]/100*z_scaling
    z_tall = zpos_terrain_tall[0,:,xleft:xright]/100*z_scaling
    #Plot variables
    if j == 1:
        disp_plot = plt.contourf(xpos[0,:,xleft:xright], z, mean_x_disp[:,xleft:xright]*hor_resolution/1000, xlevels, cmap = shifted_cmapx, alpha = 1, zorder = 3, extend = 'both')
    if j == 2:
        disp_plot = plt.contourf(xpos_small[0,:,xleft:xright], z_small, mean_x_disp_small[:,xleft:xright]*hor_resolution/1000, xlevels,  cmap = shifted_cmapx, alpha = 1, zorder = 3, extend = 'both') #Percentage
    if j == 3:
        disp_plot = plt.contourf(xpos_tall[0,:,xleft:xright], z_tall, mean_x_disp_tall[:,xleft:xright]*hor_resolution/1000, xlevels,  cmap = shifted_cmapx, alpha = 1, zorder = 3, extend = 'both') #Percentage

#    if j == 1:
#        disp_plot = plt.contourf(xpos[0,:,xleft:xright], z_small, mean_z_disp[:,xleft:xright]-mean_z_disp_small[:,xleft:xright], zlevels, cmap = shifted_cmapz, alpha = 1, zorder = 3, extend = 'both')
#    if j == 2:
#        disp_plot = plt.contourf(xpos_small[0,:,xleft:xright], z_tall, mean_z_disp[:,xleft:xright]-mean_z_disp_tall[:,xleft:xright], zlevels,  cmap = shifted_cmapz, alpha = 1, zorder = 3, extend = 'both') #Percentage
#    if j == 3:
#        disp_plot = plt.contourf(xpos_tall[0,:,xleft:xright], z_tall, mean_z_disp_small[:,xleft:xright]-mean_z_disp_tall[:,xleft:xright], zlevels,  cmap = shifted_cmapz, alpha = 1, zorder = 3, extend = 'both') #Percentage
#        
    #Plot Terrain
    z_terrain  = zpos_terrain[0,0,xleft:xright]/100*z_scaling-2
    z_terrain_small  = zpos_terrain_small[0,0,xleft:xright]/100*z_scaling-2
    z_terrain_tall  = zpos_terrain_tall[0,0,xleft:xright]/100*z_scaling-2
    if j == 1:
        terrain = plt.plot(x1d[xleft:xright], z_terrain, c = 'slategrey', linewidth = 5)
    if j == 2:
        terrain = plt.plot(x1d[xleft:xright], z_terrain_small, c = 'slategrey', linewidth = 5)
    if j == 3:
        terrain = plt.plot(x1d[xleft:xright], z_terrain_tall, c = 'slategrey', linewidth = 5)
    
    #Plot Lake
    lake = model_run.xland[0,ymid,:].values
    lake[lake == 1] = np.nan
    lake_plt = plt.plot(x1d[xleft:xright], lake[xleft:xright]-2, c = 'blue', linewidth = 4, zorder = 6)
    
    #Title
    if j == 1:
        plt.title("Time-Mean Streamwise Displacement", fontsize = 24, y = 1.1)
        #plt.title("Time-mean change in ${\Theta}$", fontsize = 24, y = 1.1)
        #plt.title("Time-Mean Vertical Displacement", fontsize = 24, y = 1.1)
        
    #Labels
    sub_label = ['No Mountain', '500m Mountain', '2000m Mountain']
    props = dict(boxstyle='square', facecolor='white', alpha=1)
    ax.text(0.01, 0.845, sub_label[j-1], fontsize = 20, bbox = props, zorder = 5, transform=ax.transAxes)
    
    
    #Info
    if j == 3:
        sub_title = '[Run: Low Wind]'
        ax.text(0.85, -0.28, sub_title, fontsize = 24, transform=ax.transAxes)
    ...
    #Colorbar
    zcbaxes = fig.add_axes([0.92, 0.25, 0.03, 0.5])             
    zcbar = plt.colorbar(disp_plot, cax = zcbaxes, ticks = xlevels_ticks)
    zcbar.ax.set_yticklabels(xlevels_ticks_labels)
    zcbar.ax.tick_params(labelsize=15)
    plt.text(0.13, -0.1, 'km', fontsize = 21)#.29
...
plt.savefig("/uufs/chpc.utah.edu/common/home/u1013082/public_html/phd_plots/cm1/plots/time_x_15ms.png", dpi=200)
plt.close(fig)
...
#plt.yticks(ytick)
#ax.set_xticklabels(np.arange(0,ds.nx*200/1000,40), fontsize = 10)
#plt.xlim([0,ds.uinterp[0,0,0,:].size])
#plt.ylim([-50,ytick[-1]])
...
#
#
#plt.savefig("/uufs/chpc.utah.edu/common/home/u1013082/public_html/phd_plots/cm1/plots/backward_trajectory_0000m_15ms_60sec.png", dpi = 200)
#plt.close(fig)
#    
#
#
